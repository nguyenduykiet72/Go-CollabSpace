        ...
        <div className="flex flex-1 items-center">
          <div className="max-w-xl">
            <p className="text-xs font-medium uppercase text-amber-100">
              Real-time study workspace
            </p>
            <h1 className="mt-4 text-4xl font-semibold tracking-tight text-white drop-shadow-sm">
              Keep notes, drafts, and discussions in the same room.
            </h1>
            <p className="mt-4 text-sm leading-6 text-white/82 drop-shadow-sm">
              GoCollab pairs document collaboration with workspace roles so
              groups can learn together without losing context.
            </p>
            <div className="mt-8 grid gap-4 select-none">
              {[
                { icon: BookOpen, label: "Shared class notes" },
                { icon: MessageSquareText, label: "Discussion-ready docs" },
                { icon: Users, label: "Team spaces with roles" },
              ].map((item) => (
                <div
                  key={item.label}
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mb-6">
            ...
            <p className="mt-2 text-sm text-slate-500">
              Open your workspace and continue learning with your group.
            </p>
          </div>
